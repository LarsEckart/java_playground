...
public class B_Comparators {
   ...
   * name is the same, uses their first name.
   */
  @Test
  @Ignore
   ...
   * comparator04() exercise. That is, the person with the greater last name should be ordered
   * first. If two persons have the same last name, the one with the greater first name should be
   * ordered first.
   */
  @Test
  @Ignore
