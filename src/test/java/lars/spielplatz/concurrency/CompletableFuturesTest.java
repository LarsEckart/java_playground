...
class CompletableFuturesTest {
  ...
  void allOfJoinDoOthersCompleteThrows() {
    ...
    CompletableFuture<Void> fourthFuture = CompletableFuture.runAsync(() -> {
      try {
        Thread.sleep(500);
    ...
    CompletableFuture<Void> secondFuture2 = CompletableFuture.runAsync(() -> {
      System.out.println("22");
      throw new IllegalStateException("boom");
    });

    CompletableFuture<Void> allFutures = CompletableFuture.allOf(firstFuture, secondFuture, thirdFuture, fourthFuture, secondFuture2);
