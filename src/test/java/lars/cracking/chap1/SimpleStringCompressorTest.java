...
public class SimpleStringCompressorTest {
  ...
  @Test
  public void returns_original_string_when_compressed_string_is_longer_than_original()
      throws Exception {
  ...
  @Test
  public void returns_compressed_string_when_compressed_string_is_shorter_than_original()
      throws Exception {
