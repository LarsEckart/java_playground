...
public class CustomerTest {
    ...
    void statement() {
        ...
        customer.addRental(new Rental(new Movie("Fantastic BBeasts And Where To Find Them", Movie.NEW_RELEASE), 4));

        assertThat(customer.statement()).isEqualTo("Rental Record for Any\n"
                + "\tHarry Potter\t1.5\n"
                + "\tHarry Potter II\t3.0\n"
                + "\tDie Hard\t2.0\n"
                + "\tDie Hard II\t2.0\n"
