...
public class SequenceSumCalculator_Should {
    ...
    @Test
    public void calculate_sum_of_digits_that_are_equal_to_next_digit_in_sequence()
            throws Exception {
    ...
    @Test
    public void calculate_sum_of_digits_that_are_equal_to_digit_that_is_half_the_sequence_length_away()
            throws Exception {
        SequenceSumCalculator calculator = new SequenceSumCalculator();
