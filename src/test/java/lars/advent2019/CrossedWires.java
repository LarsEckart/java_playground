...
class CrossedWires {
    ...
    void more_more_example() {
        ...
        grid.pathTo("R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51\n"
                + "U98,R91,D20,R16,D67,R40,U7,R15,U6,R7");

        assertThat(grid.closestIntersectionDistance()).isEqualTo(135);
    }

    @Disabled("not yet, more_example is failing for whatever reason :<")
    @Test
    void solution() {
        Grid grid = new Grid();
        ...
        assertThat(grid.closestIntersectionDistance()).isEqualTo(4);
    }
