...
public class ConcurrencyForHumans {
    ...
    /**
     * can result in lots of threads.
     * how would we know we're done?
     */
    ...
    // a fixed size thread pool (sized to the available cores) is appropriate for computationally expensive tasks;
    // a variable sized pool is appropriate for tasks that are short or block a lot; a ForkJoinPool is appropriate
