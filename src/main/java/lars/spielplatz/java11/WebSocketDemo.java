...
/**
 * from https://github.com/ralscha/blog2019/blob/master/java11httpclient/client/src/main/java/ch/rasc/httpclient/WebSocketDemo.java
 * <p>
 * Notice that the Java 11 WebSocket client, like the WebSocket API in the browser, does not
