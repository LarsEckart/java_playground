...
public class OneAway {
  ...
  /**
   * Replace each of first's characters with each of second's characters and figure out if the words
   * then match. bale balo -> bale aale lale oale -> bble bale blle bole -> babe baae bale baoe ->
   * balb bala ball balo
   */
