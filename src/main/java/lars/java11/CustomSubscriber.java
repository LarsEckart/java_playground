...
public class CustomSubscriber {
    ...
    public CompletableFuture<String> get(String url) {
        ...
        return httpClient.sendAsync(request, responseInfo -> new StringSubscriber())
    ...
    public CompletableFuture<String> getFlow(String url) {
        ...
        HttpResponse.BodyHandler<String> bodySubscriber =
                HttpResponse.BodyHandlers.fromSubscriber(new StringFlowSubscriber(), StringFlowSubscriber::getBody);

        return httpClient.sendAsync(request, bodySubscriber)
                .whenComplete((r, t) -> System.out.println("status code: " + r.statusCode()))
                .thenApply(HttpResponse::body);
    }
