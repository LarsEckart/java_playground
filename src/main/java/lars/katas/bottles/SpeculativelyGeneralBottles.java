...
public class SpeculativelyGeneralBottles extends Bottles {
    ...
    private Function<Verse, String> noMore = (verse) -> "No more bottles of beer on the wall, " +
            "no more bottles of beer.\n" +
            "Go to the store and buy some more, " +
            "99 bottles of beer on the wall.\n";

    private Function<Verse, String> lastOne = (verse) -> "1 bottle of beer on the wall, " +
            "1 bottle of beer.\n" +
            "Take it down and pass it around, " +
            "no more bottles of beer on the wall.\n";

    private Function<Verse, String> penultimate = (verse) -> "2 bottles of beer on the wall, " +
            "2 bottles of beer.\n" +
            "Take one down and pass it around, " +
            "1 bottle of beer on the wall.\n";

    private Function<Verse, String> normal = (verse) -> verse.number + " bottles of beer on the wall, " +
