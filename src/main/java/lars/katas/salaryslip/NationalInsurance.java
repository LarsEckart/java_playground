...
class NationalInsurance {
  ...
  private static final BigDecimal HIGH_INSURANCE_CONTRIBUTION_THRESHOLD =
      BigDecimal.valueOf(43_000.00);
  ...
  private BigDecimal normalContribution() {
    ...
    return amountAboveThreshold
        .divide(BigDecimal.valueOf(100), RoundingMode.HALF_UP)
        .multiply(BigDecimal.valueOf(12));
  }

  BigDecimal highContribution() {
    var amountWithHighContribution =
        annualGrossSalary.subtract(HIGH_INSURANCE_CONTRIBUTION_THRESHOLD);
    var highContributionAmount = amountWithHighContribution.multiply(BigDecimal.valueOf(0.02));
    var amountWithNormalContribution =
        annualGrossSalary
            .subtract(amountWithHighContribution)
            .subtract(INSURANCE_CONTRIBUTION_THRESHOLD);
