...
class Room {
  ...
  public void measureTemperature() {
    ...
    if (currentTemp < todaysTemperatureRange.getLow()) {
      this.todaysTemperatureRange =
          new TemperatureRange(currentTemp, this.todaysTemperatureRange.getHigh());
    }
    if (currentTemp > todaysTemperatureRange.getHigh()) {
      this.todaysTemperatureRange =
          new TemperatureRange(this.todaysTemperatureRange.getLow(), currentTemp);
    }
  }
