package lars.refactoring.drinking;
...
class DrinkMachine {
      ...
      try {
        ...
        if (input.equals("")) {
          ...
          updateMakeable();
            ...
            && Integer.parseInt(input) <= drinkList.size()) { // dynamic drink menu selection
  ...
  public static void addAllDrinks() {
    ...
    addDrink(
        "Decaf Coffee",
        new String[] {"Decaf Coffee", "Decaf Coffee", "Decaf Coffee", "Sugar", "Cream"});
