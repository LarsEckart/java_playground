 ...
 *
 * <p>This class mirrors an <code>ArrayList&lt;String&gt;</code> in some functionality, but is
 * simpler to use and fits the Duke/Coursersa model of creating and using iterables.
 *
 * <p>Example usage:
 *
 * <PRE>
