...
/**
 * The <code>Pixel</code> class represents a color as its component values of red, green, blue, as
 * well as alpha (for transparency).
 *
 * <p>Each of the component values of a pixel must have a value between 0 and 255. If a value is
 * given outside that range, it is changed to be within that range. As such, a negative value would
 * be set to 0 and a value greater than 255 would be set to 255.
 *
 * <p>Example usage:
 *
 * <pre>
 ...
 * </pre>
 *
 * <p>This is open-source software released under the terms of the GPL
...
public class Pixel {
  ...
  /**
   * Resets the value of the pixel's red component to the value passed as a parameter. If it is not
   * in the range of 0-255 it is changed to be in that range.
   *
   * @param r the red value
   */
  ...
  /**
   * Resets the value of the pixel's green component to the value passed as a parameter. If it is
   * not in the range of 0-255 it is changed to be in that range.
   *
   * @param g the green value
   */
  ...
  /**
   * Resets the value of the pixel's blue component to the value passed as a parameter. If it is not
   * in the range of 0-255 it is changed to be in that range.
   *
   * @param b the blue value
   */
  ...
  /**
   * Resets the value of the pixel's alpha (or transparency) component to the value passed as a
   * parameter. If it is not in the range of 0-255 it is changed to be in that range.
   *
   * @param a the alpha value
   */
