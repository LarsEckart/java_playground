 ...
 *
 * <p>A location can consist of a latitude, longitude, timestamp, and other information such as
...
public class Location {
   ...
   *
   * <p>By default time, latitude and longitude are 0, and the location has no bearing, altitude,
   * speed, accuracy or extras.
   *
  ...
  private static void computeDistanceAndBearing(
      double lat1, double lon1, double lat2, double lon2, float[] results) {
   ...
   * the WGS84 ellipsoid.
   *
   * <p>The computed distance is stored in results[0]. If results has length 2 or greater, the
   * initial bearing is stored in results[1]. If results has length 3 or greater, the final bearing
   * is stored in results[2].
   *
   ...
   *
   * <p>On the other hand, {@link #getTime} is useful for presenting a human readable time to the
   * user, or for carefully comparing location fixes across reboot or across devices.
   *
   * <p>All locations generated by the {@link LocationManager} are guaranteed to have a valid UTC
   * time, however remember that the system time may have changed since the location was generated.
   *
   ...
   *
   * <p>This value can be reliably compared to {@link android.os.SystemClock#elapsedRealtimeNanos},
   * to calculate the age of a fix and to compare Location fixes. This is reliable because elapsed
   * real-time is guaranteed monotonic for each system boot and continues to increment even when the
   * system is in deep sleep (unlike {@link #getTime}.
   *
   * <p>All locations generated by the {@link LocationManager} are guaranteed to have a valid
   * elapsed real-time.
   *
   ...
   *
   * <p>All locations generated by the {@link LocationManager} will have a valid latitude.
   */
   ...
   *
   * <p>All locations generated by the {@link LocationManager} will have a valid longitude.
   */
   ...
   *
   * <p>Following this call {@link #hasAltitude} will return false, and {@link #getAltitude} will
   * return 0.0.
   */
   ...
   *
   * <p>Following this call {@link #hasSpeed} will return false, and {@link #getSpeed} will return
   * 0.0.
   */
   ...
   *
   * <p>Bearing is the horizontal direction of travel of this device, and is not related to the
   * device orientation. It is guaranteed to be in the range (0.0, 360.0] if the device has a
   * bearing.
   *
   ...
   *
   * <p>Following this call {@link #hasBearing} will return false, and {@link #getBearing} will
   * return 0.0.
   */
   ...
   *
   * <p>All locations generated by the {@link LocationManager} have an accuracy.
   */
   ...
   *
   * <p>We define accuracy as the radius of 68% confidence. In other words, if you draw a circle
   ...
   *
   * <p>In statistical terms, it is assumed that location errors are random with a normal
   * distribution, so the 68% confidence circle represents one standard deviation. Note that in
   * practice, location errors do not always follow such a simple distribution.
   *
   * <p>This accuracy estimation is only concerned with horizontal accuracy, and does not indicate
   * the accuracy of bearing, velocity or altitude if those are included in this Location.
   *
   * <p>If this location does not have an accuracy, then 0.0 is returned. All locations generated by
   * the {@link LocationManager} include an accuracy.
   */
   ...
   *
   * <p>Following this call {@link #hasAccuracy} will return false, and {@link #getAccuracy} will
   * return 0.0.
   */
