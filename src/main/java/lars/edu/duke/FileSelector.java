...
/**
 * This utility class creates a thread safe file dialog box for loading and saving files.
 *
...
class FileSelector {
  ...
  private static File[] selectFiles(
      String[] extensionAccepted, final boolean allowMultiple, final boolean openForRead) {
